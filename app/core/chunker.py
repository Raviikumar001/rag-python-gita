...
class DocumentChunker:
    """Semantic chunker optimized for the Bhagavad Gita structure."""
    ...
    def _get_chapter_number(self, text: str) -> int:
        ...
        if match:
            ...
            for i in range(len(roman_numeral)):
                if (
                    i > 0
                    and roman_values[roman_numeral[i]] > roman_values[roman_numeral[i - 1]]
                ):
                    integer_value += (
                        roman_values[roman_numeral[i]]
    ...
    def _save_chunks(self, chunks: List[Dict[str, str]]) -> None:
        ...
        complete_output = {"metadata": self.metadata, "chunks": chunks}
